...
import { X, Code, FileText, CheckCircle2 } from 'lucide-react';
    ...
    <div style={{
      ...
      <div className="glass-panel" style={{
        ...
        <div style={{ marginBottom: '24px' }}>
          <h3 style={{ display: 'flex', alignItems: 'center', gap: '8px', fontSize: '1rem', marginBottom: '12px' }}><FileText size={18} color="var(--accent-blue)" /> Evaluated Rationale</h3>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px', color: 'var(--accent-success)', fontSize: '0.85rem', fontWeight: '500' }}>
          <CheckCircle2 size={16} /> Rule verified against Fact Checker ground truth
        </div>
      </div>
    </div>
  );
